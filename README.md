...
class RoboticsEngineer:
    ...
    location   = "Earth (occasionally simulated)"
    focus      = ["Autonomous Systems", "Motion Planning", "Perception", "Embedded Control"]
    stack      = ["ROS2", "Python", "C++", "MATLAB", "Simulink"]
    currently  = "Building robots that navigate the real world 🤖"
    open_to    = "Collaboration, research & cool robotics problems"
```
...
![ROS2](https://img.shields.io/badge/ROS2-22314E?style=for-the-badge&logo=ros&logoColor=00b4d8)
![Gazebo](https://img.shields.io/badge/Gazebo-FF6B00?style=for-the-badge&logoColor=white)
![MATLAB](https://img.shields.io/badge/MATLAB-0076A8?style=for-the-badge&logo=mathworks&logoColor=white)
![Simulink](https://img.shields.io/badge/Simulink-0076A8?style=for-the-badge&logo=mathworks&logoColor=orange)
...
|--------|-------------|-------|
| 🛰️ **[Autonomous Nav Stack](https://github.com/AswinSrinivasan253)** | ROS2-based autonomous navigation with real-time obstacle avoidance | ROS2, C++, Python |
| 👁️ **[Perception Pipeline](https://github.com/AswinSrinivasan253)** | LiDAR + camera fusion for 3D object detection | OpenCV, PyTorch, PCL |
| 🦾 **[Arm Motion Planner](https://github.com/AswinSrinivasan253)** | Trajectory planning for 6-DOF manipulator using MoveIt2 | ROS2, MoveIt2, C++ |
| 📐 **[SLAM from Scratch](https://github.com/AswinSrinivasan253)** | Implementing EKF-SLAM in a Gazebo simulated environment | Python, MATLAB, Gazebo |
